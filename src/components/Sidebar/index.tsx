...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    ...
    <aside 
      ...
      ref={sidebar}
      style={{ backgroundColor: '#FF0000',width:200 }} 
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col bg-black overflow-y-hidden  duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
                    ...
                    <React.Fragment>
                      <NavLink
                        ...
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out  ${
                          ...
                          (pathname === '/' ||
                            pathname.includes('dashboard')) &&{ backgroundColor: '#000000' }
